...
# Add the Helion Eucalyptus Development Root Certification Authority to
# the Python botocore module trusted root certificates:

cat << EOF >> /usr/lib/python2.?/site-packages/botocore/vendored/requests/cacert.pem
