#/bin/bash
#
# This script tests Eucalyptus IAM permissions
#
...
echo "Testing permissions script not yet implemented. This is a placeholder."

echo
echo "Permissions testing complete"
