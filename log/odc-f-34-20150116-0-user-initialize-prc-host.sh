[root@odc-f-34 ~]# mkdir ~/bin
cd ~/bin
wget https://raw.githubusercontent.com/eucalyptus/euca-demo/master/bin/user-initialize-prc-host.sh
[root@odc-f-34 ~]# cd ~/bin
[root@odc-f-34 bin]# wget https://raw.githubusercontent.com/eucalyptus/euca-demo/master/bin/user-initialize-prc-host.sh
--2015-01-16 00:18:43--  https://raw.githubusercontent.com/eucalyptus/euca-demo/master/bin/user-initialize-prc-host.sh
./user-initialize-prc-host.shResolving raw.githubusercontent.com... 23.235.47.133
...
2015-01-16 00:18:43 (86.2 MB/s) - “user-initialize-prc-host.sh” saved [3286/3286]

[root@odc-f-34 bin]# chmod -R 0700 ~/bin
[root@odc-f-34 bin]# ./user-initialize-prc-host.sh
...
# sed -i -e "1 s/root:x:0:0:root/root:x:0:0:odc-f-34/" /etc/passwd
...
[root@odc-f-34 bin]# exit
logout

Last login: Fri Jan 16 00:20:36 2015 from euca-vpn-10-5-1-94.eucalyptus-systems.com
