[root@odc-f-34 ~]# euca-faststart-02-configure-cloudformation.sh -I
...
euca_conf --register-service -T CloudFormation -H 10.104.10.76 -N cfn

Continuing in  1 seconds...

# euca_conf --register-service -T CloudFormation -H 10.104.10.76 -N cfn
Created new partition 'cfn'
SERVICE cloudformation          cfn             cfn                     http://10.104.10.76:8773/services/CloudFormatioarn:euca:bootstrap:cfn:cloudformation:cfn/
...
To setup the environment run: source /path/to/eucarc
  ...
  inflating: /root/creds/eucalyptus/admin/euca2-admin-6f3fe7b2-pk.pem  
  inflating: /root/creds/eucalyptus/admin/euca2-admin-6f3fe7b2-cert.pem  
#
# source /root/creds/eucalyptus/admin/eucarc
