[root@odc-c-23 ~]# mkdir ~/bin
cd ~/bin
wget https://raw.githubusercontent.com/eucalyptus/euca-demo/master/bin/user-initialize-prc-host.sh
[root@odc-c-23 ~]# cd ~/bin
[root@odc-c-23 bin]# wget https://raw.githubusercontent.com/eucalyptus/euca-demo/master/bin/user-initialize-prc-host.sh
./user-initialize-prc-host.sh--2015-01-16 00:19:24--  https://raw.githubusercontent.com/eucalyptus/euca-demo/master/bin/user-initialize-prc-host.sh
...
2015-01-16 00:19:24 (44.8 MB/s) - “user-initialize-prc-host.sh” saved [3286/3286]

[root@odc-c-23 bin]# chmod -R 0700 ~/bin
[root@odc-c-23 bin]# ./user-initialize-prc-host.sh
...
# sed -i -e "1 s/root:x:0:0:root/root:x:0:0:odc-c-23/" /etc/passwd
...
[root@odc-c-23 bin]# exit
logout

Last login: Fri Jan 16 00:19:05 2015 from euca-vpn-10-5-1-94.eucalyptus-systems.com
